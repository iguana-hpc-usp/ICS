...
func ContainerStart(c string) container.ContainerCreateCreatedBody {
	...
	config := &container.Config{ Image: "containers_master" }
	hostConfig := &container.HostConfig{
		NetworkMode: "net-cluster-usp",
		Mounts: []mount.Mount{
			{
				Type:   mount.TypeBind,
